...
const addProductDetails = async (req, res) => {
    const {user, name, brand, size, category, subCategory, highlights, description, mrp, price, countInStock, warranty, origin, specifications, manufacturer, url} = req.body;
